...
class SmsCodeValidator extends Model
{
     ...
     * @throws Exception
     */
    public function validateIpSmsCode(): void
    {
        ...
        if ($codeRequestsCountIp >= AbstractSmsCode::MAX_PER_IP) {
            throw $e = new Exception(Yii::t('app-sm-user', 'Превышено число попыток с вашего IP адреса. Попробуйте завтра или обратитесь к администратору ресурса'));
        }
    }
     ...
     * @throws Exception
     */
    public function validatePhoneSmsCode(): void
    {
        ...
        if ($codeRequestsCountPhone >= AbstractSmsCode::MAX_PER_DAY) {
            throw $e = new Exception(Yii::t('app-sm-user', 'Превышено число попыток. Попробуйте завтра или обратитесь к администратору ресурса'));
        }
    }
}
